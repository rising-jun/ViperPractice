...
class SplashInteractor: SplashInteractorInputProtocol{
    ...
    func requestDatas() {
        Observable.zip(getNetFlixTop10(), getInstaTop10(), getNaverTop10())
            .subscribe(onNext: { (netFlixList,instaList,naverList) in
                self.presenter?.giveDatas(netflixList: netFlixList, instaList: instaList, naverList: naverList)
